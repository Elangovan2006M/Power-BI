...
![Intro](screenshots/page1.png)
### 1. Account Details & Overview
![Account Details](screenshots/page2.png)
*Provides a high-level view of churn rate (26.54%), total customers (7,043), and revenue impact.*

### 2. Demographics & Subscriptions
![Demographics](screenshots/page3.png)
![Demographics](screenshots/page4.png)
![Demographics](screenshots/page5.png)
![Demographics](screenshots/page6.png)
*Analyzes churn by gender, seniority, and contract type.*

### 3. Service & Support Analysis
![Services](screenshots/page7.png)
![Services](screenshots/page8.png)
